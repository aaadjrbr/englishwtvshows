...
function checkAnswer(selectedOption) {
    ...
    if (selectedOption === currentDialogue.correctOption) {
        ...
        if (currentDialogueIndex < dialogues.length) {
            ...
            dialogueElement.textContent = 'Congratulations, you have completed the dialogue!';
...
giveUpButton.addEventListener('click', () => {
    ...
    window.location.href = 'https://example.com/your-other-page.html'; // Replace with the desired URL
});
